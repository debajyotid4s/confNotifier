...
CREATE TABLE IF NOT EXISTS conferences (
    ...
    notification_of_acceptance_deadline DATE,
    notification_of_acceptance_deadline_label TEXT,
    notification_of_acceptance_deadline_previous DATE,
...
-- Migrate from UNIQUE(website) to UNIQUE(website, date_start) with NULLS NOT DISTINCT so TBA (date_start IS NULL) dedups correctly
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_conferences_website_date ON conferences (website, date_start) NULLS NOT DISTINCT;
