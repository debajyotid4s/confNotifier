...
-- conferences: 5 named deadline types (abstract, full_paper,
-- notification_of_acceptance, camera_ready, registration)
...
ALTER TABLE conferences ADD COLUMN IF NOT EXISTS notification_of_acceptance_deadline DATE;
ALTER TABLE conferences ADD COLUMN IF NOT EXISTS notification_of_acceptance_deadline_label TEXT;
ALTER TABLE conferences ADD COLUMN IF NOT EXISTS notification_of_acceptance_deadline_previous DATE;
